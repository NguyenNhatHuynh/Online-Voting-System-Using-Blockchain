...
var addCandidateRoute = require("./routes/addCandidate");
var updateVouterStatus = require("./routes/updateVoterStatus");

app.use("/", updateVouterStatus);
app.use("/", addCandidateRoute);
