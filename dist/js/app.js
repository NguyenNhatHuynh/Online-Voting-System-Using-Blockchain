...
App = {
    ...
    render: function () {
            ...
            App.contracts.Contest.deployed()
                ...
                for (var i = 1; i <= contestantsCount; i++) {
                    contestInstance.contestants(i).then(function (contestant) {
                        ...
                        var contestantOption = "<option style='padding: auto;' value='" +
                            id +
                            "'>" +
                            name +
                            "</option>";
                        contestantSelect.append(contestantOption);
                        var contestantTemplateAdmin = "<tr><th>" +
                            id +
                            "</th><td>" +
                            name +
                            "</td><td>" +
        ...
        App.contracts.Contest.deployed()
            ...
            var phaseTemplateAdmin = "<h3> Giai đoạn hiện tại: " + fetchedStateAdmin + "</h3>";
